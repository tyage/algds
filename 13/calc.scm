...
(define install-rational-package (lambda ()
  ...
  (put 'add '(rational rational)
       (lambda (x y) (simplification (tag (add-rat x y)))))
  (put 'sub '(rational rational)
       (lambda (x y) (simplification (tag (sub-rat x y)))))
  (put 'mul '(rational rational)
       (lambda (x y) (simplification (tag (mel-rat x y)))))
  (put 'div '(rational rational)
       (lambda (x y) (simplification (tag (div-rat x y)))))
  (put 'make '(rational)
...
(define install-real-package (lambda ()
  ...
  (put 'add '(real real)
    (lambda (x y) (simplification (tag (+ x y)))))
  (put 'sub '(real real)
    (lambda (x y) (simplification (tag (- x y)))))
  (put 'mul '(real real)
    (lambda (x y) (simplification (tag (* x y)))))
...
(define install-complex-package (lambda ()
  ...
  (put 'add '(complex complex)
       (lambda (z1 z2) (simplification (tag (add-complex z1 z2)))))
  (put 'sub '(complex complex)
       (lambda (z1 z2) (simplification (tag (sub-complex z1 z2)))))
  (put 'mul '(complex complex)
       (lambda (z1 z2) (simplification (tag (mul-complex z1 z2)))))
  (put 'div '(complex complex)
       (lambda (z1 z2) (simplification (tag (div-complex z1 z2)))))
...
(define simplification (lambda (x)
    (if (or 
            (eq? (type-tag x) 'scheme-number)
            (eq? (type-tag x) (type-tag (drop x)))
        )
        x
        (simplification (drop x)))
))
